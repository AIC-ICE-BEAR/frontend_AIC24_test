...
const renderImagesSimilarityForm = (ImageSimiResult, setImageSimformVisible, selectedImage, handleImageClick, handleDoubleClick, handleClickImgSim, ClipConfig, setImageSimiResult, handlePlayVideoClick) => (
      ...
      <div className="h-full grid grid-cols-5 gap-2">
        {ImageSimiResult.map((img, index) => (
          <div className={`border p-1 bg-white ${selectedImage === `${img.video_name}-${img.keyframe_id}` ? 'border-4 border-red-500' : 'border-gray-300'}`}>
            <img
              key={index}
              src={`${process.env.REACT_APP_IMAGE_PATH}/${img.video_name}/${img.keyframe_id}.jpg`}
            ...
            <div className='flex'>
              ...
              <img className="w-8 p-0.5 rounded-md  hover:bg-black"
                ...
                onClick={() => {
                  ...
                  handlePlayVideoClick(img.video_name, img.keyframe_id)
                }}
                alt="vid-watch">
              ...
              <img className="w-8 p-0.5 rounded-md  hover:bg-black"
                ...
                onClick={() => {
                  ...
                  handleDoubleClick(img.video_name, img.keyframe_id)
                }}
                alt="vid-watch">
